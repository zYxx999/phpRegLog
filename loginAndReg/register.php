...
<form class="card" action="src/actions/register.php" method="post" enctype="multipart/form-data">
    ...
    <label for="name">
        ...
        <?php if(hasValidationError('name')): ?>
            <small><?php echo validationErrorMsg('name'); ?></small>
        <?php endif; ?>
    </label>
    ...
    <label for="email">
        ...
        <?php if(hasValidationError('email')): ?>
            <small><?php echo validationErrorMsg('email'); ?></small>
        <?php endif; ?>
    </label>
    ...
    <label for="avatar">Изображение профиля
        ...
        <?php if(hasValidationError('avatar')): ?>
            <small><?php echo validationErrorMsg('avatar'); ?></small>
        <?php endif; ?>
    </label>
    ...
    <div class="grid">
        <label for="password">
            ...
            <?php if(hasValidationError('password')): ?>
                <small><?php echo validationErrorMsg('password'); ?></small>
            <?php endif; ?>
        </label>
